...
class ICameraData
{
	...
	virtual bool Load3DModel(std::string file_name, PointCloud::Ptr object_model) = 0;
	...
	virtual void ShowPointCloud_NonBlocking(const PointCloud::Ptr pointcloud, std::string window_name) = 0;

...
class ICameraData
{
	...
	virtual bool GetMaskAndLabel(cv::Mat& mask, cv::Mat& mask_collision, std::string& label) = 0;
	...
	virtual bool DepthtoPointCloud_Collision(cv::Mat Depth, cv::Mat Mask, PointCloud::Ptr pointcloud) = 0;
	...
	virtual JsonOutType ReadJsonObject(Json::Value json_object, std::string key_name, const char* out_type) = 0;

...
class IRegistration3D
{
	...
	virtual void DCP(const PointCloud::Ptr cloud_src, const PointCloud::Ptr cloud_tgt, PointCloud::Ptr output, Eigen::Matrix4f &final_transform, bool downsample) = 0;
	virtual void ComputeTransformation(const PointCloud::Ptr cloud_src, const PointCloud::Ptr cloud_tgt) = 0;
	virtual void ComputeTransformation_GPU(const PointCloud::Ptr cloud_src, const PointCloud::Ptr cloud_tgt) = 0;
